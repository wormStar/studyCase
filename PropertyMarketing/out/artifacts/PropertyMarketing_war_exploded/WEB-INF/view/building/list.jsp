        ...
        <form id="addRoom">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="totalFloor">总层数</label>
                        <input type="text" class="form-control validate[required] custom[number]" name="building.totalFloor" id="totalFloors" >
                    </div>
                    <div class="form-group">
                        <label for="floorRooms">每层户数</label>
                        <input type="text" class="form-control validate[required] custom[number]" name="building.floorRooms" id="floorRoomss" >
                    </div>
                    <div class="form-group">
                        <label for="totalRoom">总户数</label>
