        ...
        <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 col-xs-12">
            ...
            <form id="upHeadIcon" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div id="preview" class="col-lg-12 col-md-6 col-sm-3" onclick="$('#upload').click();">
                        <c:if test="${sessionScope.agency.logo == null}">
                            <img id="imghead" border="0" src="<%=path %>/img/headDefault.png" onclick="$('#upload').click();">
                        </c:if>
                        <c:if test="${sessionScope.agency.logo != null}">
                            <img id="imhead" broder="0" src="<%=path%>/${sessionScope.agency.logo}" style="width:300px; height:266px" onclick="$('#upload').click();">
                        </c:if>
                    </div>
