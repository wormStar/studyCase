...
<div>
    <div id="toolbar">
        ...
        <button class="btn btn-primary" onclick="show();">回复</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="message.content" id="content" readonly></textarea>
                    </div>
                    <div class="form-group">
                        <label for="reply">回复</label>
                        <textarea type="text" class="form-control validate[required]" name="message.reply" id="reply" placeholder="请输入回复"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <a href="javascript:void(0);" type="button" class="btn btn-default" data-dismiss="modal">关闭</a>
                    <a href="javascript:void(0);" type="button" class="btn btn-primary" onclick="reply();">确认回复</a>
                </div>
            </div>
        </form>
    </div>
