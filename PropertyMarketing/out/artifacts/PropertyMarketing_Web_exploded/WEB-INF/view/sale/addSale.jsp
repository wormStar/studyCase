    ...
    <div class="row">
        <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 col-xs-12">
            ...
            <form id="addSale">
                ...
                <div class="form-group">
                    <select class="form-control validate[required]" id="floor" name="floor" data-errormessage-value-missing="请选择楼层">

                    </select>
                </div>
                <div class="form-group">
                    <select class="form-control validate[required]" id="room" name="roomId" data-errormessage-value-missing="请选择选择房屋">

                    </select>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control validate[required] validate[custom[number]]" id="discount"  name="sale.discount" placeholder="请输入销售折扣(0-1的小数)" data-errormessage-value-missing="请输入销售折扣"/>
                </div>
